...
let highScoreElement = document.getElementById("highScoreElement");
...
function updateHighScore() {
    let currentHighScore = parseInt(highScoreElement.innerHTML);
...
window.onload = function () {
    ...
    if (savedHighScore) {
        highScoreElement.innerHTML = savedHighScore;
    } else {
        highScoreElement.innerHTML = 0; // Default high score
    }
};
